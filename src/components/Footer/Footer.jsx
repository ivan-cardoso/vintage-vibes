                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-md-6" >
                            ...
                            <div className="d-flex">
                                <a href="https://www.linkedin.com/in/ivan--cardoso/" target="_blank" rel="noreferrer" >
                                ...
                                <a href="https://github.com/ivan-cardoso" target="_blank" rel="noreferrer">
                                    <div className="footer--icon--container">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-github footer--icon" viewBox="0 0 16 16">
